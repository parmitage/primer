...
Assert(93, Sort([]), [])
Assert(94, Min([7,2,4,5,1,3,8,6,9]), 1)
Assert(95, Min([7]), 7)
Assert(96, Min([]), [])
Assert(97, Max([7,2,4,5,1,3,8,6,9]), 9)
Assert(98, Max([7,2,4,5,1,3,8,6]), 8)
Assert(99, Max([7,2,4,5,1,3,6]), 7)
Assert(100, Max([]), [])
Assert(101, Last([1,2,3,4,5]), 5)
Assert(102, Last([1]), 1)
Assert(103, Last([]), nil)
Assert(104, Odd(1), true)
Assert(105, Odd(2), false)
Assert(106, Even(1), false)
Assert(107, Even(2), true)
Assert(108, !true, false)
Assert(109, !false, true)
Assert(110, !1 == 2, true)
Assert(111, !1 == 1, false)
Assert(112, -10, -10)
Assert(113, 0-10, -10)
Assert(114, 10 * 2 - 3, 17)
Assert(115, -10 * 2 - 3, -23)
Assert(116, Type(1), 1)
Assert(117, Type(4.5), 2)
Assert(118, Type(true), 3)
Assert(119, Type(nil), 0)
Assert(120, Type(Double), 6)
Assert(121, Type(a), 1)
Assert("Integer type check", Integer(10), true)
Assert("Integer type check to fail", Integer(false), false)
Assert("Float type check", Float(10.1), true)
Assert("Float type check to fail", Float(12), false)
Assert("Boolean type check", Bool(false), true)
Assert("Boolean type check to fail", Bool(88), false)
Assert("Function type check", Function(Double), true)
Assert("Function type check 2", Function(lambda (x) x end), true)
...
Assert("String length", Length("foo"), 3)
Assert("String concatenation", "this" ++ " is " ++ "a test", "this is a test")
...
Show("this" == "this")
Show("this" == "that")
Show(Sort("qwertyuiopasdfghjklzxcvbnm"))