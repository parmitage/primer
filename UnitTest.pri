...
Assert("Library: simple Sort", Sort([7,2,4,5,1,3,8,6,9]), [1,2,3,4,5,6,7,8,9])
...
Assert("Library: string reverse", Sort("qwertyuiopasdfghjklzxcvbnm"), "abcdefghijklmnopqrstuvwxyz")
